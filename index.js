...
const { execSync } = require('child_process');        // 只需填写UPLOAD_URL将上传节点,同时填写UPLOAD_URL和PROJECT_URL将上传订阅
...
const UUID = process.env.UUID || 'e3e2fd3b-8446-4a50-9002-cc218adb2ed9'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
